 ...
 */
package com.jacarrichan.generator.internal.util.messages;
...
public class Messages {
    private static final String BUNDLE_NAME = "com.jacarrichan.generator.internal.util.messages.messages"; //$NON-NLS-1$
